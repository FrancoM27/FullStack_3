                ...
                {resenas.length > 0 ? (
                    resenas.map(r => (
                        <div key={r.id} style={{
                            ...
                            borderRadius: '10px',
                            marginBottom: '15px',
                            borderLeft: `4px solid ${colorTema}`
                        }}>
                    ...
                    <div style={{textAlign: 'center', padding: '40px', color: '#666'}}>
                        ...
                        <p style={{fontSize: '0.9rem', marginTop: '10px'}}>Dirígete al <strong>Catálogo</strong> para
                            reseñar los productos que has comprado.</p>
                    </div>
                )}
            </div>
        );
        ...
        <div style={{
            ...
            {rol === 'cliente' && haComprado && (
                <div style={{marginBottom: '30px', borderBottom: '1px solid #333', paddingBottom: '20px'}}>
                    ...
                    <div style={{marginBottom: '10px'}}>
                        {[1, 2, 3, 4, 5].map(n => (
                            <span key={n} onClick={() => setEstrellas(n)} style={{
                                cursor: 'pointer',
                                color: n <= estrellas ? '#ffcc00' : '#444',
                                fontSize: '25px'
                            }}>★</span>
                        ))}
                    </div>
                    ...
                    {mensaje && (
                        <div style={{
                            ...
                            padding: '10px',
                            borderRadius: '5px',
                            backgroundColor: mensaje.includes('Error') ? '#ff4444' : '#44ff44',
                            color: 'white'
                        }}>
                            {mensaje}
                        </div>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            marginTop: '10px',
                            backgroundColor: enviando ? '#666' : colorCian,
                            border: 'none',
                            padding: '12px',
                            fontWeight: 'bold',
            ...
            {rol === 'cliente' && !haComprado && productoId && (
                <div style={{
                    ...
                    <p style={{color: '#888', margin: 0}}>Solo los guerreros que han adquirido este producto pueden
                        dejar su testimonio.</p>
                </div>
            )}
                            ...
                            {rol === 'vendedor' && !r.respuestaVendedor && (
                                <div style={{marginTop: '15px', display: 'flex', gap: '10px'}}>
                                    <input
                                        ...
                                        onChange={(e) => setRespuestaVendedor({
                                            ...respuestaVendedor,
                                            [r.id]: e.target.value
                                        })}
                                        style={{
